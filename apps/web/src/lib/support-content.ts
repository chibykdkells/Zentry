...
export const supportFaqs = [
  {
    question: 'Who can use Ecafe?',
    answer:
      'Ecafe now supports individuals, approved CBT centers, and tenant-managed business portals. The public account flow is no longer limited to students.',
  },
  {
